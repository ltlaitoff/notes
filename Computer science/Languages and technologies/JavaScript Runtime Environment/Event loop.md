**Event loop** - це деякий нескінчений цикл в [[JavaScript]] [[Runtime Environment]], наприклад, браузері або NodeJS, який виконує [[Макрозадача|макрозадачі]], [[Мікрозадачі|мікрозадачі]] та [[Рендер]] інформації в браузері
